<script setup>
const images = {
  errorPng: 'https://blog-ultimate.oss-cn-beijing.aliyuncs.com/404.png',
  cloudPng: 'https://blog-ultimate.oss-cn-beijing.aliyuncs.com/404_cloud.png',
}

const messages = {
  bullshit__headline: 'The webmaster said that you can not enter this page...',
  bullshit__oops: 'OOPS!',
  bullshit__info:
  ...
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__headline">{{ messages.bullshit__headline }}</div>
        <div class="bullshit__info">{{ messages.bullshit__info }}</div>
        <router-link :to="{ name: 'adminDashboard' }" href="" class="bullshit__return-home"
